...
SQL – for creating tables, relationships, and performing queries

CSV files – for importing sample data
...
Support for realistic medical data such as diagnoses and appointment dates

Queries for analysis (e.g., number of appointments per doctor, department performance, patient demographics)
